...
class PNavigationBarViewController: UIViewController {
...
//		prepareButtonExample()
	...
	*/
	private func prepareDetailLabelExample() {
		...
		detailLabel.text = "Press Left Button to go Back"
	...
	*/
	private func prepareAlignTitleAndDetailLabelToLeftExample() {
		...
		btn1.setImage(img1, forState: .Normal)
		btn1.setImage(img1, forState: .Highlighted)
        btn1.addTarget(self, action: "goBack", forControlEvents: .TouchUpInside)
